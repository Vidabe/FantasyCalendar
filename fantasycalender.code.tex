        ...
        \tl_put_right:Nn \l__fantasycal_box_size_setup_tl
          {
            ...
            \tl_set:NV \l__fantasycal_draw_day_xshift_tl \l__fantasycal_tmpa_dim
            \dim_sub:Nn \l__fantasycal_tmpa_dim \l__fantasycal_box_outer_x_sep_dim
...
%                  - 1\pgflinewidth
                  ...
                  - 1\l__fantasycal_box_outer_x_sep_dim
              } 
          }
      } ,
    box ~ height/.code = 
        ...
        \tl_put_right:Nn \l__fantasycal_box_size_setup_tl
          {
            ...
            \tl_set:NV \l__fantasycal_draw_day_yshift_tl \l__fantasycal_tmpa_dim
            \dim_sub:Nn \l__fantasycal_tmpa_dim \l__fantasycal_box_outer_y_sep_dim
...
%                  - 1\pgflinewidth
                  - 2\l__fantasycal_box_inner_y_sep_dim 
                  - 1\l__fantasycal_box_outer_y_sep_dim
              } 
          }
      } ,
    box ~ size/.code = 
...
\keys_define:nn { fantasycal/print-calendar }
  {
    set-test-month .tl_set:N = \l__fantasycal_base_nr_months_per_year_int
  }
...
\cs_new:Npn \__fantasycal_print_fantasycalendar_year_setup:n #1
  {
    \str_if_in:nnTF {#1} { to }
      ...
      { 
        \fp_set:Nn \l__fantasycal_year_start_fp {#1}
        \fp_set_eq:NN  \l__fantasycal_year_end_fp \l__fantasycal_year_start_fp
      }
    \fp_compare:nNnTF
...
\cs_new:Npn \__fantasycal_print_fantasycalendar_year_setup_aux:ww #1 to #2 \relax
  {
    \fp_set:Nn \l__fantasycal_year_start_fp {#1}
    \fp_set:Nn \l__fantasycal_year_end_fp {#2}
  }
