            ...
            \tl_put_right:Nn \l__fantasycal_box_size_setup_tl
              {
                \__fantasycal_box_size_calculate_height:N \l__fantasycal_tmpa_dim
                \__fantasycal_box_setup:nnN { y } { height } \l__fantasycal_tmpa_dim
                \__fantasycal_box_size_calculate_width:N \l__fantasycal_tmpb_dim
                ...
                \dim_compare:nNnTF 
                  ...
                  { 
                    \dim_set:Nn \l__fantasycal_tmpa_dim { \l__fantasycal_calendar_box_width_tl }
                    \__fantasycal_box_setup:nnN { y } { height } \l__fantasycal_tmpa_dim
                  }{ 
                    \dim_set:Nn \l__fantasycal_tmpa_dim { \l__fantasycal_calendar_box_height_tl }
                    \__fantasycal_box_setup:nnN { x } { width } \l__fantasycal_tmpa_dim
                  }
              }
          }{
...
\cs_new:Npn \__fantasycal_box_size_calculate_height:N #1
  {
    ...
    \dim_set:Nn #1 
      { ( \textheight - \l__fantasycal_tmpa_dim ) / \l__fantasycal_tmpa_int }
...
\cs_new:Npn \__fantasycal_box_setup:nnN #1#2#3
  {
    ...
    \dim_sub:Nn #3 { \dim_use:c { l__fantasycal_box_outer_ #1 _sep_dim } }
    \tl_set:cV { l__fantasycal_calendar_box_ #2 _tl } #3
    \dim_set:cn { l__fantasycal_box_ #2 _dim }
      { 
        \tl_use:c { l__fantasycal_calendar_box_ #2 _tl }
          ...
          - \dim_use:c { l__fantasycal_box_outer_ #1 _sep_dim }*1
      } 
  }
...
\cs_new:Npn \__fantasycal_calculate_box_size:
  {
    ...
    \cs_set_eq:NN \__fantasycal_calculate_box_size: \prg_do_nothing:
  }
