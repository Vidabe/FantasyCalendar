% Based on "pgfcalendar.code.tex" by Till Tantau
...
\cs_new:Npn \__fantasycal_moon_set_moon_phase:n #1
  {
    \int_set:Nn \__fantasycal_moon_moon_phase_int
      { #1 + \__fantasycal_moon_moon_phase_shift_int }
    \int_set:Nn \__fantasycal_moon_moon_phase_int
      {
        \int_mod:nn 
...
\cs_new:Npn \__fantasycal_moon_calculate_moon_phases:nnn #1#2#3
  {
    ...
    \__fantasycal_moon_set_moon_phase:n {#3}
    ...
    \fp_set:Nn \l_tmpa_fp 
      {
        360*\__fantasycal_moon_moon_phase_int 
          / \__fantasycal_moon_lunar_cycle_int
      }
...
\cs_new:Npn \__fantasycal_moon_if_moon_phase_setup:N #1
  {
    \__fantasycal_moon_get_stored:NNN #1 
      \__fantasycal_moon_lunar_cycle_int 
      \__fantasycal_moon_moon_phase_shift_int
    \__fantasycal_moon_set_moon_phase:n \l_fantasycal_base_current_ordinal_int
  }
\cs_new:Npn \__fantasycal_moon_if_moon_phase_match:Nnn #1 #2#3
  {
    \__fantasycal_moon_if_moon_phase_setup:N #1
...
\cs_new:Npn \__fantasycal_moon_if_moon_phase_behavior:Nnn #1 #2#3
  {
    \__fantasycal_moon_if_moon_phase_setup:N #1
    \int_compare:nNnF { \__fantasycal_moon_moon_phase_int } = { 0 }
      {
        \int_compare:nNnT \__fantasycal_moon_moon_phase_int 
          #2
          { \__fantasycal_moon_lunar_cycle_int * #3 }
...
\cs_new:Npn \__fantasycal_moon_if_moon_phase_behavior_ii:Nnnnn #1 #2#3#4#5
  {
    \__fantasycal_moon_if_moon_phase_setup:N #1
    \int_compare:nNnT \__fantasycal_moon_moon_phase_int 
    #2
    ...
    \pgfkeys
      {
        ...
        /pgf/#2/full-moon/ .code= 
          {  \__fantasycal_moon_if_moon_phase_match:Nnn #1 = { 0 } } ,
        /pgf/#2/new-moon/ .code= 
          { \__fantasycal_moon_if_moon_phase_match:Nnn #1 = { 1/2 } } ,
        /pgf/#2/half-moon-1/ .code= 
          { \__fantasycal_moon_if_moon_phase_match:Nnn #1 = { 1/4 } } ,
        /pgf/#2/half-moon-2/ .code= 
          { \__fantasycal_moon_if_moon_phase_match:Nnn #1 = { 3/4 } } ,
        /pgf/#2/waxing/ .code= 
          { 
        ...
        /pgf/#2/waxing-crescent/ .code=  
          { 
            \__fantasycal_moon_if_moon_phase_behavior_ii:Nnnnn #1 < { 1/4 } > { 0 }  
          } , 
        /pgf/#2/waxing-gibbous/ .code=  % <
          { 
            \__fantasycal_moon_if_moon_phase_behavior_ii:Nnnnn #1 < { 1/2 } > { 1/4 } 
          } , 
        /pgf/#2/waning-gibbous/ .code=  % <
          { 
            \__fantasycal_moon_if_moon_phase_behavior_ii:Nnnnn #1 > { 1/2 } < { 3/4 }  % >
          } , 
        /pgf/#2/waning-crescent/ .code=  % <
          { 
            \__fantasycal_moon_if_moon_phase_behavior_ii:Nnnnn #1 > { 3/4 } < { 1 }  % >
          } , 
      }
  }
...
\cs_new:Npn \__fantasycal_moon_next_phase_setup:Nnn #1#2#3
  {  
    ...
    \__fantasycal_moon_set_moon_phase:n { \l__fantasycal_moon_ordinal_day_int }
...
\cs_new:Npn \__fantasycal_base_ordinal_to_dates:N #1
  {
...
\cs_new:Npn \__fantasycal_moon_is_today_a_phase:n #1
  {
    ...
    \int_compare:nNnT
      { \l_tmpa_int } = { \__fantasycal_moon_tmpa_int }  
      {
        ...
        \__fantasycal_base_ordinal_to_dates:N \l__fantasycal_moon_ordinal_day_int
        #1
    ...
    \bool_while_do:Nn \l__fantasycal_moon_get_next_moon_phase_bool
      {
        ...
        \__fantasycal_moon_check_if_in_time_frame:T
          {
            \__fantasycal_base_ordinal_to_dates:N 
              \l__fantasycal_moon_next_phase_day_int
            #4
          }
   ...
   \bool_if:NTF \l__fantasycal_moon_overlap_found_bool
     {
       ...
       \__fantasycal_base_ordinal_to_dates:N \l__fantasycal_moon_val_a_int
       #1
     }{
       No-overlap-found!
     }
...
%\cs_new:Npn \__fantasycal_moon_lcm:NN #1#2
%  {
%    \int_set_eq:NN \l_tmpa_int #1
%    \int_set_eq:NN \l_tmpb_int #2
%    \__fantasycal_moon_gdc:NN \l_tmpa_int \l_tmpb_int
%    \int_set:Nn \l__fantasycal_moon_lunarshift_int { #1*#2 / \l_tmpa_int }
%  }
