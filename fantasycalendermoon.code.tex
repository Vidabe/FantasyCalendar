    ...
    \fp_compare:nNnTF { \l_tmpa_fp } = 1
      ...
      { 
        \fp_compare:nNnTF { \l_tmpa_fp} = { -1  }
          { 
            \bool_if:NTF \l__fantasycalendarmoon_decreasing_bool
              { \int_set:Nn \__fantasycalendarmoon_moon_case_int { 1 } } %% black moon
              { \int_set:Nn \__fantasycalendarmoon_moon_case_int { 0 } } %% white
            \use_none_delimit_by_q_recursion_stop:w
          }
          {
...
\int_new:N \l_val_a_int
\int_new:N \l_val_b_int
...
\cs_new:Npn \__fantasycalendarmoon_compare_moons:nnnn #1#2#3#4
  {
   ...
   \use:c { __fantasycalendarmoon_moon_funcy_ 1 :Nn } \l_val_a_int { 0 }
   \use:c { __fantasycalendarmoon_moon_funcy_ 2 :Nn } \l_val_b_int { 0 } 
         ...
         { \l_val_a_int } = { \l_val_b_int }
         {
           ...
           \int_compare:nNnTF { \l__fantasycalendarmoon_counter_int } < \l_moon_depth_int
             { 
               ...
               \bool_set_true:N \l_tmpa_bool 
               \int_set:Nn \l_moon_counter_int
                 { \l__fantasycalendarmoon_threshold_int + 1 }
             }{ 
               \use:c { __fantasycalendarmoon_moon_funcy_ \int_use:N \l_moon_depth_int :Nn } 
                 \l_val_b_int { 0 }
             }
         }{
           \int_compare:nNnTF { \l_val_a_int } < { \l_val_b_int }
             { 
               %% Welp. "Reset" loop.
               \int_set:Nn \l_moon_depth_int { 1 }
               \int_incr:c { l__fantasycalendarmoon_vali_ \int_use:N \l_moon_depth_int _int }  
               \__fantasycalendarmoon_moon_set_value:NV \l_val_a_int \l_moon_depth_int 
               \int_incr:N \l_moon_depth_int 
             }{ 
               \int_incr:c { l__fantasycalendarmoon_vali_ \int_use:N \l_moon_depth_int _int }
               \__fantasycalendarmoon_moon_set_value:NV \l_val_b_int \l_moon_depth_int 
             }
         }
     }
   \bool_if:NTF \l_tmpa_bool
     {
       \int_set_eq:NN \l__fantasycalendarmoon_next_phase_day_int \l_val_a_int
       \int_set:Nn \l__fantasycalendarmoon_in_days_int
         { \l_val_a_int - \l__fantasycalendarmoon_initial_ordinal_day_int }
       \__fantasycalendarmoon_the_dates:N \l_val_a_int
       #4
     }{
       No-overlap-found!
     }
   
  \int_compare:nNnT \l__fantasycalendarmoon_max_nr_of_entries_int > 0
     {
       \int_set:Nn \l_moon_counter_int { 1 }
       \int_set:Nn \l_wen_int { \seq_item:Nn \l__fantasycalendarmoon_lunar_cycles_seq { 1 } }
       \int_set:Nn \l_chen_int { \seq_item:Nn \l__fantasycalendarmoon_lunar_cycles_seq { 2 } }
       \__fantasycalendarmoon_lcm:NN \l_wen_int \l_chen_int
       \int_step_inline:nn { \l__fantasycalendarmoon_max_nr_of_entries_int - 1 }
         {
           \int_add:Nn \l_val_a_int \l__fantasycalendarmoon_lunarshift_int
         \int_set_eq:NN \l__fantasycalendarmoon_next_phase_day_int \l_val_a_int
         \int_set:Nn \l__fantasycalendarmoon_in_days_int
           { \l_val_a_int - \l__fantasycalendarmoon_initial_ordinal_day_int }
         \__fantasycalendarmoon_the_dates:N \l_val_a_int
...
\NewDocumentCommand \CompareMoons { m m m +m }
  {
    \group_begin:
    \cs_set_eq:NN \% \__fantasycalendarmoon_shortcut:n
    \__fantasycalendarmoon_compare_moons:nnnn {#1} {#2} {#3} {#4}
    \group_end:
  }
...
\cs_new:Npn \__fantasycalendarmoon_moon_set_value:Nn #1#2
  {
    \exp_args:cNv 
      { __fantasycalendarmoon_moon_funcy_ #2 :Nn  } 
      #1 
