...
\cs_new:Npn \__fantasycalendarmoon_calculate_moon_phases:nnn #1#2#3
  {
    ...
    \int_compare:nNnT
      { \__fantasycalendarmoon_moon_phase_int }
      =
      { \__fantasycalendarmoon_lunar_cycle_int / 2 }
      {
        %% New moon (all black)
...
\NewDocumentCommand \DefineNewMoon { m m m }
  {
    ...
    \__fantasycalendar_add_pgf_moon_keys:Nx #1 { \cs_to_str:N #1 }
...
\cs_new:Npn \__fantasycalendarmoon_get_stored:NNN #1 #2#3
  {
    \int_set_eq:Nc #2 { c__fantasycalendarmoon_ \cs_to_str:N #1 _lunar_cycle_int }
    \int_set_eq:Nc #3 { c__fantasycalendarmoon_ \cs_to_str:N #1 _offset_int }
  }


\cs_new:Npn \__fantasycalendar_if_moon_phase_setup:N #1
  {
    \__fantasycalendarmoon_get_stored:NNN #1 
      \__fantasycalendarmoon_lunar_cycle_int 
      \__fantasycalendarmoon_moon_phase_shift_int
    \__fantasycalendarmoon_set_moon_phase:n \l_fantasycalendar_current_ordinal_int
  }
\cs_new:Npn \__fantasycalendar_if_moon_phase_match:Nnn #1 #2#3
  {
    \__fantasycalendar_if_moon_phase_setup:N #1
    \int_compare:nNnT \__fantasycalendarmoon_moon_phase_int 
      #2
      { \__fantasycalendarmoon_lunar_cycle_int * #3 }
      { \bool_set_true:N \l__fantasycalendar_date_match_bool }
  }
\cs_new:Npn \__fantasycalendar_if_moon_phase_behavior:Nnn #1 #2#3
  {
    \__fantasycalendar_if_moon_phase_setup:N #1
    \int_compare:nNnF { \__fantasycalendarmoon_moon_phase_int } = { 0 }
      {
        \int_compare:nNnT \__fantasycalendarmoon_moon_phase_int 
          #2
          { \__fantasycalendarmoon_lunar_cycle_int * #3 }
...
\cs_new:Npn \__fantasycalendar_if_moon_phase_behavior_ii:Nnnnn #1 #2#3#4#5
  {
    \__fantasycalendar_if_moon_phase_setup:N #1
    \int_compare:nNnT \__fantasycalendarmoon_moon_phase_int 
    #2
    ...
    { 
      \int_compare:nNnT \__fantasycalendarmoon_moon_phase_int
        #4
        { \__fantasycalendarmoon_lunar_cycle_int * #5 }
        { \bool_set_true:N \l__fantasycalendar_date_match_bool }
    }
  }

\cs_new:Npn \__fantasycalendar_add_pgf_moon_keys:Nn #1#2
  {
    \pgfkeys
      {
        /pgf/#2/.is~choice ,
        /pgf/#2/full-moon/ .code= 
          {  \__fantasycalendar_if_moon_phase_match:Nnn #1 = { 0 } } ,
        /pgf/#2/new-moon/ .code= 
          { \__fantasycalendar_if_moon_phase_match:Nnn #1 = { 1/2 } } ,
        /pgf/#2/half-moon-1/ .code= 
          { \__fantasycalendar_if_moon_phase_match:Nnn #1 = { 1/4 } } ,
        /pgf/#2/half-moon-2/ .code= 
          { \__fantasycalendar_if_moon_phase_match:Nnn #1 = { 3/4 } } ,
        /pgf/#2/waxing/ .code= 
          { 
            \__fantasycalendar_if_moon_phase_behavior:Nnn #1 < { 1/2 } 
          } , % >
        /pgf/#2/waning/ .code=  % <
          { 
            \__fantasycalendar_if_moon_phase_behavior:Nnn #1 > { 1/2 } 
        ...
        /pgf/#2/waxing-crescent/ .code=  
          { 
            \__fantasycalendar_if_moon_phase_behavior_ii:Nnnnn #1 < { 1/4 } > { 0 }  
          } , 
        /pgf/#2/waxing-gibbous/ .code=  % <
          { 
            \__fantasycalendar_if_moon_phase_behavior_ii:Nnnnn #1 < { 1/2 } > { 1/4 } 
          } , 
        /pgf/#2/waning-gibbous/ .code=  % <
          { 
            \__fantasycalendar_if_moon_phase_behavior_ii:Nnnnn #1 > { 1/2 } < { 3/4 }  % >
          } , 
        /pgf/#2/waning-crescent/ .code=  % <
          { 
            \__fantasycalendar_if_moon_phase_behavior_ii:Nnnnn #1 > { 3/4 } < { 1 }  % >
          } , 
      }
  }
\cs_generate_variant:Nn \__fantasycalendar_add_pgf_moon_keys:Nn { Nx }
...
\bool_new:N \l__fantasycalendarmoon_nr_entries_are_given_int
...
\prg_new_conditional:Npnn \__fantasycalendar_check_if_loop_ends: { F }
  {
    \bool_if:NTF \l__fantasycalendarmoon_nr_entries_are_given_int
      {
    ...
    \bool_if:NTF \l__fantasycalendarmoon_get_next_moon_phase_bool
      { \prg_return_false: }
      { \prg_return_true: }
  }
...
\cs_new:Npn \__fantasycalendar_check_if_in_time_frame:T #1
  {
    \int_compare:nNnTF
      ...
      \l__fantasycalendarmoon_ordinal_end_day_plus_one_int
      { \bool_set_true:N  } { \bool_set_false:N  }
      \l__fantasycalendarmoon_still_inside_timeframe_bool
%
    \bool_lazy_or:nnT
...
\cs_new:Npn \__fantasycalendarmoon_next_phase_setup:Nnn #1#2#3
  {  
    ...
    \bool_set_false:N \l__fantasycalendarmoon_found_day_bool
    ...
    \int_compare:nNnTF \l__fantasycalendarmoon_max_nr_of_entries_int = 0
      { \bool_set_false:N } { \bool_set_true:N } 
      \l__fantasycalendarmoon_nr_entries_are_given_int
...
\cs_new:Npn \__fantasycalendarmoon_ordinal_to_dates:N #1
  {
...
\cs_new:Npn \__fantasycalendarmoon_is_today_a_phase:n #1
  {
    \int_compare:nNnTF { \__fantasycalendarmoon_moon_phase_int } = { 0 }
      { \int_set_eq:NN \l_tmpa_int \__fantasycalendarmoon_lunar_cycle_int }
      { \int_set_eq:NN \l_tmpa_int \__fantasycalendarmoon_moon_phase_int }
    \int_compare:nNnT
      { \l_tmpa_int } = { \__fantasycalendarmoon_tmpa_int }  
      {
        \int_zero:N \l__fantasycalendarmoon_in_days_int
        \__fantasycalendarmoon_ordinal_to_dates:N \l__fantasycalendarmoon_ordinal_day_int
        #1
        \bool_set_true:N \l__fantasycalendarmoon_found_day_bool
        \__fantasycalendar_check_if_loop_ends:F { }
      }
  }
...
\cs_new:Npn \__fantasycalendarmoon_calc_continued_phases:
  {      
    ...
    \int_set_eq:NN \l__fantasycalendarmoon_in_days_int 
      \__fantasycalendarmoon_lunar_cycle_int
...
\bool_new:N \l__fantasycalendarmoon_found_day_bool
...
\NewDocumentCommand \GetNextMoonphase { m m m +m }
  {
    ...
    \bool_if:NT \l__fantasycalendarmoon_check_input_date_bool
      { \__fantasycalendarmoon_is_today_a_phase:n {#4} }
% 
    \bool_while_do:Nn \l__fantasycalendarmoon_get_next_moon_phase_bool
      {
        \bool_if:NTF \l__fantasycalendarmoon_found_day_bool
          { \__fantasycalendarmoon_calc_continued_phases: }
          { 
        ...
        \__fantasycalendar_check_if_in_time_frame:T
          {
            \__fantasycalendarmoon_ordinal_to_dates:N 
              \l__fantasycalendarmoon_next_phase_day_int
            #4
          }
...
\cs_new:Npn \__fantasycalendarmoon_compare_moons_setup_aux:nnn #1#2#3
  {
    ...
    \__fantasycalendarmoon_is_today_a_phase:n 
      {
    ...
    \__fantasycalendarmoon_create_moon_function:nVV
      { \int_use:N \l__fantasycalendarmoon_nr_moons_int } 
...
\cs_new:Npn \__fantasycalendarmoon_create_moon_function_II:nnnn #1#2#3#4
  {
    \cs_set:cpn { __fantasycalendarmoon_moon_funcy_II_ #1 :Nn } ##1 ##2
      {
        \int_set:Nn \l__fantasycalendarmoon_tmpb_int {#2 + #3*##2}
        \fp_set:Nn ##1 { \l__fantasycalendarmoon_tmpb_int*#4}
      }
  }
\cs_generate_variant:Nn \__fantasycalendarmoon_create_moon_function_II:nnnn { nVVV }
...
\int_new:N \l__fantasycalendarmoon_nr_moons_int
...
\bool_new:N \l__fantasycalendarmoon_overlap_found_bool
...
\cs_new:Npn \__fantasycalendarmoon_compare_moons_setup:nnn #1#2#3
  {
   ...
   \int_zero:N \l__fantasycalendarmoon_nr_moons_int
   \clist_map_inline:nn {#1}
     { 
       \int_incr:N \l__fantasycalendarmoon_nr_moons_int
       \__fantasycalendarmoon_compare_moons_setup_aux:nnn {##1} {#2} {#3} 
     }

    \int_set:Nn \l_tmpa_int { \seq_item:Nn \l__fantasycalendarmoon_starting_days_seq { 1 } }
    \int_set:Nn \l__fantasycalendarmoon_main_lunar_cycle_int 
      { \seq_item:Nn \l__fantasycalendarmoon_lunar_cycles_seq { 1 } }
    \int_step_inline:nnn { 2 } { \l__fantasycalendarmoon_nr_moons_int }
      {
        \fp_set:Nn \l_tmpa_fp
          {
            1 / \seq_item:Nn \l__fantasycalendarmoon_lunar_cycles_seq {##1}
          }
        \int_set:Nn \l_tmpb_int
          {
            \l_tmpa_int - \seq_item:Nn \l__fantasycalendarmoon_starting_days_seq {##1}
          }
        \__fantasycalendarmoon_create_moon_function_II:nVVV {##1} \l_tmpb_int
          \l__fantasycalendarmoon_main_lunar_cycle_int \l_tmpa_fp
      }
...
%           \int_compare:nNnTF { \l__fantasycalendarmoon_nr_moons_int } < \l_moon_depth_int
%             { 
...
\cs_new:Npn \__fantasycalendarmoon_compare_moons_print:n #1
  {
   \bool_if:NTF \l__fantasycalendarmoon_overlap_found_bool
     {
       ...
       \__fantasycalendarmoon_ordinal_to_dates:N \l__fantasycalendarmoon_val_a_int
       #1
     }{
       No-overlap-found!
     }
  ...
  \bool_lazy_and:nnT
    { \l__fantasycalendarmoon_overlap_found_bool }
...
\int_new:N \l__fantasycalendarmoon_main_lunar_cycle_int
...
\cs_new:Npn \__fantasycalendarmoon_compare_moons:
  {    
    ...
    \bool_set_false:N \l__fantasycalendarmoon_overlap_found_bool 
    ...
    \int_do_until:nNnn \l_moon_counter_int > \l__fantasycalendarmoon_threshold_int
      {
        \int_incr:N \l_moon_counter_int
        \use:c { __fantasycalendarmoon_moon_funcy_II_ \int_use:N \l_moon_depth_int :Nn }
          \l_tmpa_fp { \l__fantasycalendarmoon_counter_int }
        \fp_compare:nNnTF { \l_tmpa_fp } = { \fp_to_int:N \l_tmpa_fp }
          { 
            \int_compare:nNnTF { \l__fantasycalendarmoon_nr_moons_int } = \l_moon_depth_int
              {
                \bool_set_true:N \l__fantasycalendarmoon_overlap_found_bool 
                \int_set:Nn \l__fantasycalendarmoon_val_a_int 
                  { 
                    \seq_item:Nn \l__fantasycalendarmoon_lunar_cycles_seq { 1 }
                      *\l__fantasycalendarmoon_counter_int + 
                      \seq_item:Nn \l__fantasycalendarmoon_starting_days_seq { 1 }
                  }
                \int_set:Nn \l_moon_counter_int { \l__fantasycalendarmoon_threshold_int + 1 }
              }
              { \int_incr:N \l_moon_depth_int }
...
\cs_new:Npn \__fantasycalendarmoon_moon_set_value:Nnn #1#2#3
  {
    \use:c { __fantasycalendarmoon_moon_funcy_ #2 :Nn  } #1 {#3} 
  }


\cs_new:Npn \__fantasycalendarmoon_lcm_by_seq:
  {
    \int_set:Nn \l_tmpa_int { \seq_item:Nn \l__fantasycalendarmoon_lunar_cycles_seq { 1 } }
    \seq_map_inline:Nn \l__fantasycalendarmoon_lunar_cycles_seq
      {
