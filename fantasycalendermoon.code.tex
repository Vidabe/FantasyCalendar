    ...
    \pgfkeys
      {
        ...
        /pgf/#2/waxing-crescent/ .code=  % <
          { 
            \__fantasycalendar_if_moon_phase_behavior_ii:Nnnnn #1 > { 0 } < { 1/4 }  % >
          } , 
        /pgf/#2/waxing-gibbous/ .code=  % <
          { 
            \__fantasycalendar_if_moon_phase_behavior_ii:Nnnnn #1 > { 1/4 } < { 1/2 }  % >
          } , 
...
\cs_new:Npn \__fantasycalendarmoon_is_today_a_phase:n #1
  {
    ...
    \int_compare:nNnT
      { \l_tmpa_int } = { \__fantasycalendarmoon_tmpa_int }  
      {
        ...
        \__fantasycalendar_check_if_loop_ends:
      }
  }
