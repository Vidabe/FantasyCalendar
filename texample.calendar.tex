...
\ExplSyntaxOn
\def\hkjwefhkwehkj{\l__fantasycal_box_height_dim}
\def\wefjghhjwgjfwe{\l__fantasycal_box_width_dim}
\newcommand\testboxA{\color{blue}\rule{\wefjghhjwgjfwe}{\hkjwefhkwehkj}}

\tl_put_right:Nn \l__fantasycal_code_day_tl
  {
