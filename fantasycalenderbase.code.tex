...
\cs_new:Npn \__fantasycal_base_define_month_at_half_year:NN #1#2
  {
    ...
    \int_set_eq:NN \l__fantasycal_base_default_nr_days_of_half_year_int
      \l__fantasycal_base_nr_days_of_half_year_int
  }
        ...
        \bool_if:NF \l__fantasycal_base_date_match_bool
          {
            ...
            \bool_if:NTF \l__activate_leap_year_bool
              {
                \__fantasycal_base_experimental_get_year_from_ordinal:Nn
                ...
                \__fantasycal_base_experimental_leap_year_detected:
                ...
                \int_compare:nNnT { \l__fantasycal_base_tmpa_int } 
...
\cs_new:Npn \__fantasycal_base_iso_to_ordinal:nN #1#2
  {
    ...
    \exp_after:wN
    \__fantasycal_base_split_iso:wwwww \l_tmpa_tl +/ {#2}
  }
...
\cs_new:Npn \__fantasycal_base_ordinal_to_date:nNNN #1#2#3#4
  {
    ...
    \bool_if:NTF \l__activate_leap_year_bool
      {
        \__fantasycal_base_experimental_days_til_year_start:NN \l__fantasycal_base_year_int
          \l_tmpb_int
      }{
        \int_set:Nn \l_tmpb_int 
          { \l__fantasycal_base_year_int*\l__fantasycal_base_default_nr_days_per_year_int }
      }
    ...
    \tl_set:NV #3 \l__fantasycal_base_month_int
    \tl_set:NV #4 \l__fantasycal_base_day_int
  }
...
%\tl_new:N \l__fantasycal_base_leap_storage_tl
...
%    \cs_set_eq:NN \ifdate \__fantasycal_base_experimental_if_leap_condition:nT
%    #1
%  }

\bool_new:N \l__activate_leap_year_bool
\bool_set_false:N \l__activate_leap_year_bool 

\NewDocumentCommand \DefineLeapYear { +m m }
  {
    \fp_zero:N \l__fantasycal_base_leap_year_fraction_fp
     \__fantasycal_base_experimental_if_leap_condition:nT {#1} {#2}
     \bool_set_true:N \l__activate_leap_year_bool
  }

\cs_new:Npn \__fantasycal_base_experimental_if_leap_condition:nT #1#2
  {
%    \tl_clear:N \l__fantasycal_base_leap_storage_tl
    \tl_set:Nn \l__fantasycal_base_leap_year_stored_conditions_tl
      { \bool_set_false:N \l__fantasycal_base_leap_year_bool }
    \cs_set:Npn \__fantasycal_base_check_if_leap_year:n ##1
      { \bool_set_false:N \l__fantasycal_base_leap_year_bool }
    \int_zero:N \l__fantasycal_base_leap_nr_days_added_int
    \int_incr:N \l__fantasycal_base_counter_lp_int
    \__fantasycal_base_experimental_leap_year_additions:n {#2}
%
    \__fantasycal_base_experimental_lp_start:ww
...
%      
    ...
    \__fantasycal_base_add_to_checking:n
      { \int_compare:nNnT { 0 } = {##1} { \bool_set_false:N \l__fantasycal_base_leap_year_bool } }
  }

\cs_new:Npn \__fantasycal_base_experimental_leap_year_additions:n #1
  {
    \prop_set_from_keyval:Nn \l__fantasycal_base_leap_year_storage_prop {#1}
    \prop_map_inline:Nn \l__fantasycal_base_leap_year_storage_prop
      { \int_add:Nn \l__fantasycal_base_leap_nr_days_added_int {##2} }
  }

\cs_new:Npn \__fantasycal_base_experimental_lp_start:ww #1 year ~ #2 divisible ~ by ~ #3;
  {
    \int_set:Nn \l_tmpa_int {#3}
    \__fantasycal_base_experimental_lp_store:nV {#2} \l_tmpa_int
    \peek_meaning_ignore_spaces:NTF b
      { \__fantasycal_base_experimental_lp_contin:ww }
      { \use_none_delimit_by_q_recursion_stop:w }
  }
\cs_new:Npn \__fantasycal_base_experimental_lp_contin:ww #1 but ~ #2 divisible ~ by ~ #3;
  {
    \int_set:Nn \l_tmpa_int {#3}
    \__fantasycal_base_experimental_lp_store:nV {#2} \l_tmpa_int
    \peek_meaning_ignore_spaces:NTF b
...
\cs_new:Npn \__fantasycal_base_experimental_lp_store:nn #1#2
  {
    \str_if_eq:nnTF { not~ } {#1}
      { 
        \fp_sub:Nn \l__fantasycal_base_leap_year_fraction_fp { 1/#2 }
        \__fantasycal_base_experimental_lp_store_aux:nN {#2} \bool_set_false:N
        \__fantasycal_base_experimental_lp_store_aux_ii:nnV {#2} { - }
          \l__fantasycal_base_leap_nr_days_added_int
      }{ 
        \fp_add:Nn \l__fantasycal_base_leap_year_fraction_fp { 1/#2 }
        \__fantasycal_base_experimental_lp_store_aux:nN {#2} \bool_set_true:N
        \__fantasycal_base_experimental_lp_store_aux_ii:nnV {#2} { + }
          \l__fantasycal_base_leap_nr_days_added_int
      }
  }
\cs_generate_variant:Nn \__fantasycal_base_experimental_lp_store:nn { nV }
\cs_new:Npn \__fantasycal_base_experimental_lp_store_aux:nN #1#2
  {
    \__fantasycal_base_add_to_checking:n
      {
        \int_compare:nNnT
          { \int_mod:nn {##1} {#1} } = { 0 }
          { #2 \l__fantasycal_base_leap_year_bool }
      }
  }
\cs_new:Npn \__fantasycal_base_experimental_lp_store_aux_ii:nnn #1#2#3
  {
    \__fantasycal_base_check_add_leap_year_days_put_right:n
      { #2 \int_div_truncate:nn { \int_abs:n {##1} } {#1}*#3 }
  }
\cs_generate_variant:Nn \__fantasycal_base_experimental_lp_store_aux_ii:nnn { nnV }

\cs_new:Npn \__fantasycal_base_experimental_leap_year_final_storage:n #1
  {
    \tl_put_right:Nn \l__fantasycal_base_leap_year_add_days_tl {#1}
  }
\cs_generate_variant:Nn \__fantasycal_base_experimental_leap_year_final_storage:n { V }
...
\cs_new:Npn \__fantasycal_base_add_to_checking:n #1 
  { 
    \cs_set:Npo \__fantasycal_base_check_if_leap_year:n ##1
      {
...
\cs_new:Npn \__fantasycal_base_check_add_leap_year_days_put_right:n #1 
  { 
    \cs_set:Npo \__fantasycal_base_check_add_leap_year_days:n ##1
      {
...
\cs_new:Npn \__fantasycal_base_experimental_get_year_from_ordinal:Nn #1#2
  {
    \group_begin:
    %% To get approximate year
    \fp_set_eq:NN \l_tmpa_fp \l__fantasycal_base_leap_year_fraction_fp
    \fp_add:Nn \l_tmpa_fp \l__fantasycal_base_default_nr_days_per_year_int
    ...
    \bool_do_until:Nn \l__fantasycal_base_test_year_loop_bool
      {
        \int_set_eq:NN \l__fantasycal_base_year_int \l__fantasycal_base_test_year_int
        %% Check leap year conditions
        \int_set_eq:NN \l__fantasycal_base_nr_days_per_year_int
            \l__fantasycal_base_default_nr_days_per_year_int
        \__fantasycal_base_check_if_leap_year:n { \l__fantasycal_base_test_year_int }
        \bool_if:NT \l__fantasycal_base_leap_year_bool
          { \int_add:Nn \l__fantasycal_base_nr_days_per_year_int {\l__fantasycal_base_leap_nr_days_added_int }  }
        ...
        \int_compare:nNnTF { \l__fantasycal_base_test_ordinal_int } < { 0 }
          { \int_decr:N \l__fantasycal_base_test_year_int }
          {
            ...
            \int_compare:nNnTF 
              \l__fantasycal_base_test_ordinal_int = \l__fantasycal_base_nr_days_per_year_int
              {
                %% Found it!
...
\cs_new:Npn \__fantasycal_base_experimental_days_til_year_start:NN #1#2
  {
    \group_begin:
      \int_set_eq:NN \l__fantasycal_base_year_int #1
      \__fantasycal_base_check_if_leap_year:n {#1}
      \int_set:Nn \l__fantasycal_base_test_ordinal_int
        { 
          \__fantasycal_base_print_days_til_start_of_year:n \l__fantasycal_base_year_int
    ...
    \exp_args:NNNV
    \group_end:
    \int_set:Nn #2 \l__fantasycal_base_test_ordinal_int
  }

\cs_new:Npn \__fantasycal_base_experimental_leap_year_detected:
  {
    ...
    \seq_map_indexed_inline:Nn \l__fantasycal_base_month_names_seq
     {
       \prop_get:NnNTF \l__fantasycal_base_leap_year_storage_prop {##2}
         \l_tmpa_tl
         { \int_set:Nn \l_tmpa_int { \l_tmpa_tl } }
         { \int_zero:N \l_tmpa_int }
       \int_add:Nn \l_tmpa_int 
         { \seq_item:Nn \l__fantasycal_base_default_number_days_of_months_seq {##1} }
       \seq_put_right:NV \l_tmpa_seq \l_tmpa_int
     }
   \seq_set_eq:NN \l__fantasycal_base_number_days_of_months_seq \l_tmpa_seq
   \seq_clear:N \l__fantasycal_base_cumulative_number_days_seq
   \seq_clear:N \l__fantasycal_base_cumulative_number_days_invers_seq
   \int_zero:N \l_tmpa_int
   \int_set:Nn \l__fantasycal_base_nr_days_per_year_int
     {
       \l__fantasycal_base_default_nr_days_per_year_int +
       \l__fantasycal_base_leap_nr_days_added_int
     }
   \seq_map_inline:Nn \l__fantasycal_base_number_days_of_months_seq
     {
       \seq_put_right:NV \l__fantasycal_base_cumulative_number_days_seq \l_tmpa_int
       \seq_put_left:NV \l__fantasycal_base_cumulative_number_days_invers_seq \l_tmpa_int
...
%  {
%    \int_zero:N \l_tmpa_int
%    \prop_set_from_keyval:Nn \l__fantasycal_base_leap_storage_prop {#2}
%    \prop_map_inline:Nn \l__fantasycal_base_leap_storage_prop
%      { 
%        \int_add:Nn \l_tmpa_int {##2}
%      }
%%
%    \__fantasycal_base_experimental_parse_leap_condition:ww 
%      #1 \q_recursion_tail \q_recursion_stop
%    \tl_put_right:Nn \l__fantasycal_base_leap_storage_tl
%      {
%        \bool_if:NT \l__fantasycal_base_leap_year_bool
%          { \__fantasycal_base_experimental_leap_year_true:n {#2} }
%      }
%  }
%\cs_new:Npn \__fantasycal_base_experimental_parse_leap_condition:ww #1 year ~ #2 divisible ~ by ~ #3;
%  {
%    \__fantasycal_base_experimental_add_leap_condition:nn {#2} {#3}
%    \peek_meaning_ignore_spaces:NTF b
%      { \__fantasycal_base_experimental_parse_leap_condition_continue:ww }
%      { \use_none_delimit_by_q_recursion_stop:w }
%  }
%\cs_new:Npn \__fantasycal_base_experimental_parse_leap_condition_continue:ww #1 but ~ #2 divisible ~ by ~ #3;
%  {
%    \__fantasycal_base_experimental_add_leap_condition:nn {#2} {#3}
%    \peek_meaning_ignore_spaces:NTF b
%      { \__fantasycal_base_experimental_parse_leap_condition_continue:ww }
...
%  }
%
%\cs_new:Npn \__fantasycal_base_experimental_add_leap_condition:nn #1#2
%  {
%    \int_compare:nNnF \l__fantasycal_base_longest_thingy_int > {#2}
%      { \int_set:Nn \l__fantasycal_base_longest_thingy_int {#2} }
%  
%    \fp_zero:N \l_tmpa_fp
%    \str_if_eq:nnTF { not~ } {#1}
%      { \fp_sub:Nn \l_tmpa_fp }
%      { \fp_add:Nn \l_tmpa_fp }
%      { 1 / (#2) }
%    \__fantasycal_base_experimental_leap_ii:VV \l_tmpa_fp \l_tmpa_int
%  
%    \tl_put_right:Nx \l__fantasycal_base_leap_storage_tl
%      {
%        \exp_not:n { \int_compare:nNnT { \int_mod:nn { \l__fantasycal_base_year_int } {#2} } = { 0 } }
%          {
%            \str_if_eq:nnTF { not~ } {#1}
%              {
%                \exp_not:n { \bool_set_false:N \l__fantasycal_base_leap_year_bool }
%              }{
%                \exp_not:n { \bool_set_true:N \l__fantasycal_base_leap_year_bool }
%              }
%          }
%      }
%  }  
...
%\fp_new:N \l__fantasycal_base_offset_pear_year_fp
%
%
%
%\cs_new:Npn \__fantasycal_base_experimental_leap_year_true:n #1
%  {
%    \int_zero:N \l_fewjkhwfe_int
%    \seq_clear:N \l__fantasycal_base_number_days_of_months_seq
%    \seq_clear:N \l__fantasycal_base_cumulative_number_days_seq 
%    \prop_set_from_keyval:Nn \l__fantasycal_base_leap_storage_prop {#1}
%    
%    \seq_set_map_indexed_inline:Nn \l__fantasycal_base_month_names_seq
%      {
%        \prop_get:NnNTF \l__fantasycal_base_leap_storage_prop {##2} \l_tmpa_tl
...
%            + \l_wefn_int
%          }
%        \seq_put_right:NV \l__fantasycal_base_number_days_of_months_seq \l_asddfgasf_int
%        \seq_put_right:NV \l__fantasycal_base_cumulative_number_days_seq \l_fewjkhwfe_int
...
%
%
%\cs_new:Npn \__fantasycal_base_experimental_leap_ii:nn #1#2
%  {
%    \tl_put_right:Nn \l__fantasycal_base_leap_storage_ii_tl
%      { + \fp_eval:n { floor ( #1 * \l__fantasycal_base_year_int ) * #2 } }
%  }
%\cs_generate_variant:Nn \__fantasycal_base_experimental_leap_ii:nn { VV }
%
%
%
%
...
%  {
%    \int_set:Nn \l__fantasycal_base_year_int {#1}
%    \int_set:Nn \l__fantasycal_base_ordinal_date_int 
%      { \l__fantasycal_base_nr_days_per_year_int*\l__fantasycal_base_year_int  + \l__fantasycal_base_leap_storage_ii_tl }
%    \int_use:N \l__fantasycal_base_ordinal_date_int
%  }
%
%\cs_new:Npn \__fantasycal_base_experimental_get_sequence_for_year:n #1
%  {
%    \int_set:Nn \l__fantasycal_base_year_int {#1}
%    \int_set:Nn \l__fantasycal_base_ordinal_date_int 
%      { \l__fantasycal_base_nr_days_per_year_int*\l__fantasycal_base_year_int  + \l__fantasycal_base_leap_storage_ii_tl }
%    \__fantasycal_base_experimental_get_default:
%    \__fantasycal_base_experimental_leap_effects_on_parameters:n {#1}
%    \__fantasycal_base_experimental_get_stuff_until_now:
%    
%  }
%\cs_new:Npn \__fantasycal_base_experimental_get_default:
%  {
%    \seq_set_eq:NN \l__fantasycal_base_number_days_of_months_seq \l__fantasycal_base_default_number_days_of_months_seq
%    \seq_set_eq:NN \l__fantasycal_base_cumulative_number_days_seq \l__fantasycal_base_default_cumulative_number_days_seq
%    \int_set_eq:NN \l__fantasycal_base_default_nr_days_per_year_int \l__fantasycal_base_nr_days_per_year_int
%    \prop_clear:N \l_tmpa_prop 
%  }
%\cs_new:Npn \__fantasycal_base_experimental_leap_effects_on_parameters:n #1
%  {
%    \__fantasycal_base_experimental_parse_leap_options:n {#1}
%    \seq_clear:N \l__fantasycal_base_number_days_of_months_seq
%    \seq_map_indexed_inline:nn \l__fantasycal_base_month_names_seq
%      {
...
%  }
%%
%%\cs_new:Npn \__fantasycal_base_experimental_parse_leap_options:n #1
%%  {
