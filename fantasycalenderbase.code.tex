...
\cs_new:Npn \__fantasycal_base_lp_store:nn #1#2
  {
    \str_if_eq:nnTF { not~ } {#1}
      { 
        ...
        \__fantasycal_base_lp_store_aux:nN {#2} \bool_set_false:N
        \__fantasycal_base_lp_store_aux_ii:nnV {#2} { - }
          \l__fantasycal_base_leap_nr_days_added_int
      }{ 
        \fp_add:Nn \l__fantasycal_base_leap_year_fraction_fp { 1/#2 }
        \__fantasycal_base_lp_store_aux:nN {#2} \bool_set_true:N
        \__fantasycal_base_lp_store_aux_ii:nnV {#2} { + }
          \l__fantasycal_base_leap_nr_days_added_int
      }
  }
\cs_generate_variant:Nn \__fantasycal_base_lp_store:nn { nV }
\cs_new:Npn \__fantasycal_base_lp_store_aux:nN #1#2
  {
...
\cs_new:Npn \__fantasycal_base_lp_store_aux_ii:nnn #1#2#3
  {
    \__fantasycal_base_check_add_leap_year_days_put_right:n
      { #2 \int_div_truncate:nn {##1} {#1}*#3 }
  }
\cs_generate_variant:Nn \__fantasycal_base_lp_store_aux_ii:nnn { nnV }
