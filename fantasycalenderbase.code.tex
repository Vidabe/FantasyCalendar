    ...
    \seq_map_indexed_inline:Nn \l__fantasycal_base_month_names_seq
       {
         ...
         \prop_get:NnNT \l__fantasycal_base_leap_year_storage_prop {##2} \l_tmpb_tl
           { 
             ...
             \int_compare:nNnT { \l_tmpb_tl } > { 0 }
               {
                 \int_step_inline:nnn { \l_tmpa_tl + 1 } { \l_tmpa_tl + \l_tmpb_tl }
                   {
                     \seq_push:Nn \l__fantasycal_base_leap_years_day_addons_seq
                       { ##1 - ####1 }
                   }
               }
           }
...
\cs_new:Npn \__fantasycal_base_special_split_test:wwwN #1-#2-#3\relax#4
  {
    ...
    \tl_if_empty:NTF \l_tmpa_tl
      { \tl_set:Nx \l_tmpa_tl { \l_fantasycal_base_current_year_tl - #1-#2 } }
