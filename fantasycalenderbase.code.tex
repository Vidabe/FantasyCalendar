...
\int_new:N \l__fantasycal_base_nr_days_of_month_int
...
%    
    \seq_set_eq:NN \l__fantasycal_base_tmpa_seq \l__fantasycal_base_default_number_days_of_months_seq
    \seq_map_indexed_inline:Nn \l__fantasycal_base_month_names_seq
       {
         ...
         \int_set:Nn \l__fantasycal_base_nr_days_of_month_int { \l__fantasycal_base_tmpa_tl }
         \prop_pop:NnNT \l_tmpa_prop {##2} \l__fantasycal_base_tmpb_tl
           { 
             \int_add:Nn \l__fantasycal_base_leap_nr_days_added_int { \l__fantasycal_base_tmpb_tl }
             \int_add:Nn \l__fantasycal_base_nr_days_of_month_int { \l__fantasycal_base_tmpb_tl }
         ...
         \seq_put_right:NV \l__fantasycal_base_leap_year_days_per_months_seq 
           \l__fantasycal_base_nr_days_of_month_int
...
\pgfkeys
  {
    /pgf/ordinal ~ at ~ least/.cd, .value ~ required, .code=
      {
        \int_compare:nNnF
          \l_fantasycal_base_current_ordinal_int < {#1}
          { \bool_set_true:N \l__fantasycal_base_date_match_bool }
    ...
    \bool_if:NTF \l__fantasycal_activate_leap_year_bool
      {
        ...
        \int_set:Nn \l__fantasycal_base_year_int 
          { \int_div_truncate:nn \l__fantasycal_base_tmpa_int \l__fantasycal_base_default_nr_days_per_year_int }
      }
    ...
    \int_compare:nNnTF { \l__fantasycal_base_day_int } = { \c_zero_int }
      {
        ...
        \int_set_eq:NN \l__fantasycal_base_month_int 
          \l__fantasycal_base_nr_months_per_year_int
        \seq_get_right:NN \l__fantasycal_base_number_days_of_months_seq \l__fantasycal_base_tmpa_tl
      ...
      \bool_do_until:nn \l__fantasycal_base_tmpa_bool
        {
          ...
          %% Get to start of week that includes 4th january
          \__fantasycal_base_ordinal_to_weekday:nN \l__fantasycal_base_tmpa_int
            \l__fantasycal_base_tmpb_int
          \int_compare:nNnT \l__fantasycal_base_tmpb_int = \c_zero_int
            { 
          ...
          %% \l__fantasycal_base_tmpb_int - \c_one_int is caluclated first.
          %% So no braces required for correct calculation.
          \int_sub:Nn \l__fantasycal_base_tmpa_int
            { \l__fantasycal_base_tmpb_int - \c_one_int }
          %% Welp, looks like we need to go one year back.
          \int_compare:nNnTF {#1} < \l__fantasycal_base_tmpa_int
            {
              \tl_set:Nx \l_fantasycal_base_current_year_tl
                { \int_eval:n { \l_fantasycal_base_current_year_tl -1 } }
            }{
    ...
    /pgf/Easter/.cd,.default=0,.code=
      {
        ...
        \int_compare:nNnT { \l_fantasycal_base_current_ordinal_int } =
          { \l__fantasycal_base_tmpa_int + #1 }
          { \bool_set_true:N \l__fantasycal_base_date_match_bool }
      }
  }
...
\pgfkeys{/pgf/Advent/.cd,.default=0,.code={
...
%    \__fantasycal_base_modulo_zero_check:
