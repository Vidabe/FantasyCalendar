...
%      { \int_set:Nn \l__fantasycal_base_tmpb_int { - \l__fantasycal_base_tmpb_int } }
    ...
    \int_compare:nNnTF { \l__fantasycal_base_day_int } = { 0 }
      {
        ...
        %% ToDO: Store last result and make shortcut?
...
%      
    ...
    \int_set:Nn \l__fantasycal_base_nr_days_in_leap_year_int
      {
        \l__fantasycal_base_default_nr_days_per_year_int +
    ...
    \seq_map_indexed_inline:Nn \l__fantasycal_base_month_names_seq
       {
         ...
         \prop_get:NnNT \l__fantasycal_base_leap_year_storage_prop {##2} \l_tmpb_tl
           { 
             ...
             \int_add:Nn \l__fantasycal_base_leap_nr_days_added_int { \l_tmpb_int }
             \int_add:Nn \l_tmpa_int { \l_tmpb_int }
           }
         \seq_put_right:NV \l__fantasycal_base_leap_year_days_per_months_seq \l_tmpa_int
         ...
         \seq_put_left:NV \l__fantasycal_base_leap_year_inverse_cumulative_days_seq 
           \l__fantasycal_base_tmpa_int
         \int_add:Nn \l__fantasycal_base_tmpa_int \l_tmpa_int
       }
  }
    ...
    \bool_do_until:Nn \l__fantasycal_base_test_year_loop_bool
      {
        ...
        \int_compare:nNnTF { \l__fantasycal_base_test_ordinal_int } < { 0 }
          { \int_decr:N \l__fantasycal_base_test_year_int }
          {
            ...
            \__fantasycal_base_experimental_get_day_of_this_year:N 
...
\cs_new:Npn \__fantasycal_base_experimental_get_day_of_this_year:N #1
  {
