...
%      \l__fantasycal_base_nr_months_per_year_int
    \int_zero_new:c { l__fantasycal_base_month_number_ #1 _int }
    \int_set_eq:cN { l__fantasycal_base_month_number_ #1 _int }
      \l__fantasycal_base_nr_months_per_year_int
    %% Set values
             ...
             \int_compare:nNnT { \l__fantasycal_base_tmpb_tl } > { \c_zero_int }
               {
                 \int_step_inline:nnn 
                   ...
                   {
                     \seq_push:Nn \l__fantasycal_base_leap_years_day_addons_seq { ##1 - ####1 }
                   }
               }
           }
...
\cs_new:Npn \__fantasycal_base_add_to_checking:n #1 
  { 
    \cs_set:Npo \__fantasycal_base_check_if_leap_year_aux:n ##1
      {
        \__fantasycal_base_check_if_leap_year_aux:n {##1} #1
      }
  }
...
\cs_new:Npn \__fantasycal_base_check_add_leap_year_days_aux:n #1 { +0 }
    ...
    \bool_if:NTF \l__fantasycal_activate_leap_year_bool
      {
        ...
        \int_set:Nn \l__fantasycal_base_year_int 
          { 
            \int_div_truncate:nn \l__fantasycal_base_tmpa_int 
              \l__fantasycal_base_default_nr_days_per_year_int 
          }
        %% If the ordinal number is equal to the year*number_of_days
        %% we are actually at the end of last year.
        \int_compare:nNnT
          { \l__fantasycal_base_default_nr_days_per_year_int*\l__fantasycal_base_year_int }
          =
          { \l__fantasycal_base_tmpa_int }
