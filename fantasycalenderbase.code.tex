...
%
    ...
    \seq_set_eq:NN \l__fantasycalendar_default_number_days_of_months_seq
      \l__fantasycalendar_number_days_of_months_prop
        ...
        \bool_if:NF \l__fantasycalendar_date_match_bool
          {
            ...
            \int_set:Nn \l__fantasycalendar_tmpa_int
              { 
                \int_mod:nn \l__fantasycalendar_tmpa_int \l__fantasycalendar_default_nr_days_per_year_int 
              }
...
\cs_new:Npn \__fantasyclaendar_get_nr_of_days_until_start_of_year:n #1
  {
    #1*\l__fantasycalendar_default_nr_days_per_year_int %+ \l__fantasycalendar_leap_storage_ii_tl
  }
...
\cs_new:Npn \__fantasycalendar_split_iso:wwwww #1-#2-#3+#4/#5 
  {
    ...
    \int_set:Nn \l_tmpb_int
      {
        \__fantasyclaendar_get_nr_of_days_until_start_of_year:n { \l__fantasycalendar_year_int }
         + \__fantasycalendar_print_cumulative_days:n { \l__fantasycalendar_month_int }
         + \l__fantasycalendar_day_int
         + \l_tmpa_int
      }
%    \int_add:Nn \l_tmpb_int
%      { \l__fantasycalendar_leap_storage_ii_tl }
...
\cs_new:Npn \__fantasycalendar_ordinal_to_date:nNNN #1#2#3#4
  {
    ...
    %% days
    \int_set:Nn \l__fantasycalendar_day_int 
      { \l_tmpa_int - \l__fantasycalendar_year_int*\l__fantasycalendar_default_nr_days_per_year_int }
...
%\tl_new:N \l__fantasycalendar_leap_storage_ii_tl
%\prop_new:N \l__fantasycalendar_leap_storage_prop
