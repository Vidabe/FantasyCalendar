...
\pgfkeys{/pgf/Easter/.cd,.default=0,.code={%
  \__fantasycal_base_year_to_eastern_ordinal:nN { \l_fantasycal_base_current_year_tl }
    \l__fantasycal_base_tmpa_int
...
\cs_new:Npn \__fantasycal_base_get_first_advent_ordinal:nN #1#2
  {
    \group_begin:
    %% 1st Sunday before 25. December
    \__fantasycal_base_iso_to_ordinal:nN { #1-12-24 } #2
...
%\cs_new:Npn \__fantasycal_get_stuff:n #1 { \int_use:c { l__fantasycal_base_eastern_#1_int} }
%\cs_new:Npn \__fantasycal_set_stuff:nn #1#2 
%  { 
%\int_if_exist:cF {l__fantasycal_base_eastern_#1_int} {     \int_zero_new:c { l__fantasycal_base_eastern_#1_int } }
%    \int_set:cn { l__fantasycal_base_eastern_#1_int} {#2}
%  }
%\cs_new:Npn \__fantasycal_base_eastern_get:n #1
%  {
%    \group_begin:
%      \cs_set_eq:NN \% \__fantasycal_get_stuff:n
%      \cs_set_eq:NN \_ \int_div_truncate:nn
%      \cs_set_eq:NN \m \int_mod:nn
%      \__fantasycal_set_stuff:nn { X } {#1}
%      \__fantasycal_set_stuff:nn { K } { \_ { \%X } { 100 } }
%      \__fantasycal_set_stuff:nn { M } { 15 + \_{3*\%K+3}{4} - \_{8*\%K + 13}{25} }
%      \__fantasycal_set_stuff:nn { S } { 2 - \_{3*\%K+3}4 }
%      \__fantasycal_set_stuff:nn { A } { \m{\%X}{19} }
%      \__fantasycal_set_stuff:nn { D } { \m{19*\%A + \%M}{30} }
%      \__fantasycal_set_stuff:nn { R } { \_{\%D + \_{\%A}{11}}{29} }
%      \__fantasycal_set_stuff:nn { OG } { 21 + \%D - \%R }
%      \__fantasycal_set_stuff:nn { SZ } { 7 - \m{ \%X + \_{\%X}{4} + \%S }{7} } 
%      \__fantasycal_set_stuff:nn { OE } { 7 - \m{ \%{OG} - \%{SZ} }7 }
%      \__fantasycal_set_stuff:nn { OS } { \%{OG} + \%{OE} }
%    \group_end:
%  }
