      ...
      \bool_do_until:nn \l__fantasycal_base_tmpa_bool
        {
          ...
          %% Go to 4th January
          \int_add:Nn \l__fantasycal_base_tmpa_int { 4 }
...
\cs_new:cpn { __fantasycal@shorthand@k- } 
  { 
    \__fantasycal_base_ordinal_to_kalenderweek:nN 
      { \l_fantasycal_base_current_ordinal_int } 
      \l__fantasycal_base_tmpa_int 
      \int_use:N \l__fantasycal_base_tmpa_int 
  }
...
\cs_new:Npn \__fantasycal_base_modulo_zero_check:
  {
    \bool_set_true:N \l__fantasycal_base_mod_all_zero_bool
    \__fantasycal_base_modulo_zero_check_aux:N 
      \l__fantasycal_base_default_number_days_of_months_seq
    \bool_lazy_and:nnT
      { \l__fantasycal_base_mod_all_zero_bool }
      { \seq_if_empty_p:N \l__fantasycal_base_leap_year_days_per_months_seq }
      {
        \__fantasycal_base_modulo_zero_check_aux:N 
          \l__fantasycal_base_leap_year_days_per_months_seq
      }
  }
\cs_new:Npn \__fantasycal_base_modulo_zero_check_aux:N #1
  {
    \int_set_eq:NN \l__fantasycal_base_tmpc_int \l__fantasycal_base_zero_day_shift_int
    \seq_map_inline:Nn #1
      {
        \int_compare:nNnF 
          { 
            \int_mod:nn {\l__fantasycal_base_tmpc_int + ##1} { \l__fantasycal_base_nr_days_per_week_int } 
          } = { \c_zero_int }
          {
            \seq_map_break:n { \bool_set_false:N \l__fantasycal_base_mod_all_zero_bool }
          }
      }
  }
